...
As we can see, there are four variables related with the demographics of the individual (`HightestEducationLevel`, `MaritalStatus`, `Gender`, `Age`, `MonthlyFamilyIncome`).

Also, we have variables which represents the mental health of the individual: `DifficultyConcentrating`, `ThoughtSuicideLast2w`,

And finally, we have two variables selected for alcohol consumption, and we are going to select `AlcoholAmountAvgPerMonth` as our response variable.
