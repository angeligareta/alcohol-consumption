...
- **Machine Learning Models used**:
  ...
  summary(glm3)
  ```
  As it happened with the previous model, all the variables are significative according to their *p-value*. But here the metric that we are going to use to measure the performance is the `AIC` (Akaike Information Criterion), which have a value of 9737.3
